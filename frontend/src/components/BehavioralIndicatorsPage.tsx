...
const BehavioralIndicatorsPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const mockIndicators: BehavioralIndicator[] = [
      {
        id: '1',
        title: 'Problem Analysis',
        description: 'Demonstrates ability to break down complex problems into manageable components',
        observabilityLevel: 'PROFICIENT',
        measurementType: 'BEHAVIORAL_OBSERVATION',
        weight: 0.8,
        examples: 'Uses structured approach to analyze issues, asks clarifying questions',
        counterExamples: 'Jumps to conclusions without analysis',
        isActive: true,
      ...
      },
      {
        ...
        description: 'Shows full attention to speakers and demonstrates understanding',
        observabilityLevel: 'ADVANCED',
        measurementType: 'PEER_FEEDBACK',
        weight: 0.9,
        examples: 'Maintains eye contact, asks follow-up questions, summarizes key points',
    ...
    return (
      <div className="min-h-screen bg-[var(--bg-primary)] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[var(--text-secondary)]">Loading behavioral indicators...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="w-full p-8 space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Behavioral Indicators</h1>
