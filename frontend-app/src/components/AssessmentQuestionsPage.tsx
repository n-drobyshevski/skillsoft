			...
			return (
				<div className="flex flex-col max-w-xl">
					...
					<div className="text-sm text-muted-foreground">
						<Link
							href={`/competency/${indicator.competency.id}`}
		...
		const mockQuestions: AssessmentQuestion[] = [
			{
				id: "1",
				questionText:
					"When faced with a complex problem, what is your first step?",
				...
				answerOptions: [
					{
						id: "1a",
						optionText: "Break down the problem into smaller parts",
						isCorrect: true,
						points: 10,
					},
					{
						id: "1b",
						optionText: "Immediately start implementing solutions",
						isCorrect: false,
						points: 0,
					},
					{
						id: "1c",
						optionText: "Ask someone else to solve it",
						isCorrect: false,
						points: 0,
					},
					{
						id: "1d",
						optionText: "Ignore it and hope it goes away",
						isCorrect: false,
						points: 0,
					},
				],
