...
/**
 * Service for comparing multiple candidate test results within a Team Fit assessment.
...
public interface CandidateComparisonService {
    ...
    /**
     * Compare multiple test results for the same TEAM_FIT template.
     *
     ...
     * @throws IllegalArgumentException if validation fails (wrong count, mismatched templates, non-TEAM_FIT goal)
     */
